...
/* 
iA Writer URL Scheme Action for LaunchBar
...
func generateiAWriterURL(path: String) -> (urlScheme: String, docTitle: String) {
    ...
    let urlScheme = "ia-writer://open?path=\(encodedTitle)"
...
func main() {
    ...
    let (urlScheme, docTitle) = generateiAWriterURL(path: path)
