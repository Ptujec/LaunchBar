(* 
Speek English Action for LaunchBar
			...
			if (get name of every application process) contains "Music" then
				tell application "Music"
					if player state is playing then
						...
						say s using "Ava (Premium)" speaking rate 200
						-- tell application "Shortcuts Events"  to run shortcut "Englisch sprechen" with input s
